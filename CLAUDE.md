...
Workflow files for consumer repos are now generated by the Ansible playbook
`ids-deploy/playbooks/github-init.yml` from Jinja2 templates in
`ids-deploy/templates/github-workflows/`. See `ids-deploy/CLAUDE.md` for usage.
